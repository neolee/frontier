    ...
    <div class="min-h-screen bg-gray-100 dark:bg-gray-800">
      <header class="flex flex-col items-center justify-center text-gray-800 dark:text-white">
        ...
        <p class="text-3xl tracking-widest pb-10">
          with <span class="text-red-500 dark:text-red-200">holiday</span> info
        </p>
      </header>
      <div class="relative px-2">
        ...
        <button onMouseDown={onGo} type="button" class="absolute right-2 top-1.5 bottom-0 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Go!</button>
      </div>
      <div class="relative px-3 py-4">
        <pre id="display" class="px-2 bg-gray-200 text-gray-800 dark:bg-gray-600 dark:text-red-100">{renderCalendar(calendar())}</pre>
        <button onMouseDown={onCopy} hidden={(!calendar())} type="button" class="absolute right-2 top-7 text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Copy</button>
      </div>
    </div>
  );
};
