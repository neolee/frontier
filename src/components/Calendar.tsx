...
const Calendar: Component = () => {
  ...
  const onClick: JSX.EventHandler<HTMLButtonElement, MouseEvent> = () => {
    const query = moment(date(), 'YYYY-MM-DD').format('YYYYMM');
    console.log(query);
  };
  ...
  return (
    <div class="min-h-screen bg-gray-900">
      ...
      <button onMouseDown={onClick} type="button" class="text-white absolute right-5 bottom-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Go!</button>
      </div>
    </div>
  );
};
